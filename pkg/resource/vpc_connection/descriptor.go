...
const (
	FinalizerString = "finalizers.kafka.services.k8s.aws/VPCConnection"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("vpcconnections")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.VPCConnection{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.VPCConnection),
	}
}
