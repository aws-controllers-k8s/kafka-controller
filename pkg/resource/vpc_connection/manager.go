...
// +kubebuilder:rbac:groups=kafka.services.k8s.aws,resources=vpcconnections,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kafka.services.k8s.aws,resources=vpcconnections/status,verbs=get;update;patch
...
func (rm *resourceManager) IsSynced(ctx context.Context, res acktypes.AWSResource) (bool, error) {
	...
	stateCandidates := []string{"AVAILABLE"}
