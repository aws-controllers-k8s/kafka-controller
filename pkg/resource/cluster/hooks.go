...
func (rm *resourceManager) customUpdate(
	...
	case delta.DifferentAt("Spec.BrokerNodeGroupInfo.ConnectivityInfo.NetworkType") ||
		delta.DifferentAt("Spec.BrokerNodeGroupInfo.ConnectivityInfo.VPCConnectivity"):
...
func (rm *resourceManager) updateConnectivity(
	...
	if desired.ko.Spec.BrokerNodeGroupInfo != nil &&
		...
		if vc := desired.ko.Spec.BrokerNodeGroupInfo.ConnectivityInfo.VPCConnectivity; vc != nil {
...
func customPreCompare(_ *ackcompare.Delta, a, b *resource) {
	...
	if a.ko.Spec.BrokerNodeGroupInfo.ConnectivityInfo != nil {
		if a.ko.Spec.BrokerNodeGroupInfo.ConnectivityInfo.PublicAccess == nil && b.ko.Spec.BrokerNodeGroupInfo.ConnectivityInfo.PublicAccess != nil {
			a.ko.Spec.BrokerNodeGroupInfo.ConnectivityInfo.PublicAccess = b.ko.Spec.BrokerNodeGroupInfo.ConnectivityInfo.PublicAccess
		}
		// PublicAccess may still be nil here when neither the desired spec nor the
		// observed resource set it (e.g. a VPC-connectivity cluster that only
		// configures vpcConnectivity). Only default Type when the block exists.
		if a.ko.Spec.BrokerNodeGroupInfo.ConnectivityInfo.PublicAccess != nil &&
			a.ko.Spec.BrokerNodeGroupInfo.ConnectivityInfo.PublicAccess.Type == nil {
	...
	// MSK's DescribeCluster API returns LoggingInfo with explicit
	// {enabled: false} structs for disabled logging targets, while users
	// typically omit them (nil). Normalize to prevent spurious diffs.
	if a.ko.Spec.LoggingInfo == nil {
		...
		// AWS returned all targets disabled, semantically identical to user's nil.
		a.ko.Spec.LoggingInfo = nil
	} else if a.ko.Spec.LoggingInfo != nil && b.ko.Spec.LoggingInfo != nil &&
		a.ko.Spec.LoggingInfo.BrokerLogs != nil && b.ko.Spec.LoggingInfo.BrokerLogs != nil {
		if a.ko.Spec.LoggingInfo.BrokerLogs.CloudWatchLogs == nil {
			a.ko.Spec.LoggingInfo.BrokerLogs.CloudWatchLogs = b.ko.Spec.LoggingInfo.BrokerLogs.CloudWatchLogs
		}
		if a.ko.Spec.LoggingInfo.BrokerLogs.Firehose == nil {
			a.ko.Spec.LoggingInfo.BrokerLogs.Firehose = b.ko.Spec.LoggingInfo.BrokerLogs.Firehose
		}
		if a.ko.Spec.LoggingInfo.BrokerLogs.S3 == nil {
			a.ko.Spec.LoggingInfo.BrokerLogs.S3 = b.ko.Spec.LoggingInfo.BrokerLogs.S3
		}
	}
