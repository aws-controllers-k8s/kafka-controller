...
const (
	FinalizerString = "finalizers.kafka.services.k8s.aws/ServerlessCluster"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("serverlessclusters")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ServerlessCluster{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ServerlessCluster),
	}
}
