...
func (rm *resourceManager) sdkFind(
	...
	if resp.LatestRevision != nil {
		...
		ko.Status.LatestRevision = f4
	} else {
		ko.Status.LatestRevision = nil
	}
	if resp.Name != nil {
...
func (rm *resourceManager) newDescribeRequestPayload(
	r *resource,
) (*svcsdk.DescribeConfigurationInput, error) {
...
func (rm *resourceManager) newCreateRequestPayload(
	ctx context.Context,
	r *resource,
) (*svcsdk.CreateConfigurationInput, error) {
...
func (rm *resourceManager) sdkUpdate(
	...
	if resp.LatestRevision != nil {
		f1 := &svcapitypes.ConfigurationRevision{}
		if resp.LatestRevision.CreationTime != nil {
			f1.CreationTime = &metav1.Time{*resp.LatestRevision.CreationTime}
		}
		if resp.LatestRevision.Description != nil {
			f1.Description = resp.LatestRevision.Description
		}
		if resp.LatestRevision.Revision != nil {
			f1.Revision = resp.LatestRevision.Revision
		}
		ko.Status.LatestRevision = f1
	} else {
		ko.Status.LatestRevision = nil
	}
...
func (rm *resourceManager) newUpdateRequestPayload(
	...
	r *resource,
	delta *ackcompare.Delta,
) (*svcsdk.UpdateConfigurationInput, error) {
...
func (rm *resourceManager) newDeleteRequestPayload(
	r *resource,
) (*svcsdk.DeleteConfigurationInput, error) {
