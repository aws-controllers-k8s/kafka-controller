...
// +kubebuilder:rbac:groups=kafka.services.k8s.aws,resources=configurations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=kafka.services.k8s.aws,resources=configurations/status,verbs=get;update;patch
