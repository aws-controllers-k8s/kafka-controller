...
const (
	finalizerString = "finalizers.kafka.services.k8s.aws/Configuration"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("configurations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.Configuration{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.Configuration),
	}
}
