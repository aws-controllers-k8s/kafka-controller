...
CREATE_TIMEOUT_SECONDS = 60 * 40
UPGRADE_TIMEOUT_SECONDS = 60 * 90
...
class TestKafkaVersionUpgrade:
    def test_upgrade_cluster(self, kafka_version_cluster):
        ...
        assert k8s.wait_on_condition(
            ...
            "ACK.ResourceSynced",
            "True",
            wait_periods=CREATE_TIMEOUT_SECONDS // POLL_INTERVAL_SECONDS,
        ...
        assert k8s.wait_on_condition(
            ...
            "ACK.ResourceSynced",
            "True",
            wait_periods=UPGRADE_TIMEOUT_SECONDS // POLL_INTERVAL_SECONDS,
            period_length=POLL_INTERVAL_SECONDS,
        )
