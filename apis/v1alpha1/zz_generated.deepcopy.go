...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterOperationV2Serverless) DeepCopyInto(out *ClusterOperationV2Serverless) {
	*out = *in
	if in.SourceClusterInfo != nil {
		in, out := &in.SourceClusterInfo, &out.SourceClusterInfo
		*out = new(ServerlessConnectivityInfo)
		(*in).DeepCopyInto(*out)
	}
	if in.TargetClusterInfo != nil {
		in, out := &in.TargetClusterInfo, &out.TargetClusterInfo
		*out = new(ServerlessConnectivityInfo)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *ClusterOperationV2Serverless) DeepCopy() *ClusterOperationV2Serverless {
	if in == nil {
		return nil
	}
	out := new(ClusterOperationV2Serverless)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ClusterSpec) DeepCopyInto(out *ClusterSpec) {
	*out = *in
	if in.AssociatedSCRAMSecretRefs != nil {
		in, out := &in.AssociatedSCRAMSecretRefs, &out.AssociatedSCRAMSecretRefs
		*out = make([]*corev1alpha1.AWSResourceReferenceWrapper, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.AssociatedSCRAMSecrets != nil {
		in, out := &in.AssociatedSCRAMSecrets, &out.AssociatedSCRAMSecrets
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
...
func (in *Serverless) DeepCopyInto(out *Serverless) {
	*out = *in
	if in.ClientAuthentication != nil {
		in, out := &in.ClientAuthentication, &out.ClientAuthentication
		*out = new(ServerlessClientAuthentication)
		(*in).DeepCopyInto(*out)
	}
	if in.ConnectivityInfo != nil {
		in, out := &in.ConnectivityInfo, &out.ConnectivityInfo
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerlessConnectivityInfo) DeepCopyInto(out *ServerlessConnectivityInfo) {
	*out = *in
	if in.NetworkType != nil {
		in, out := &in.NetworkType, &out.NetworkType
		*out = new(string)
...
func (in *ServerlessConnectivityInfo) DeepCopy() *ServerlessConnectivityInfo {
	if in == nil {
		return nil
	}
	out := new(ServerlessConnectivityInfo)
...
func (in *TopicInfo) DeepCopyInto(out *TopicInfo) {
	*out = *in
	if in.OutOfSyncReplicaCount != nil {
		in, out := &in.OutOfSyncReplicaCount, &out.OutOfSyncReplicaCount
		*out = new(int64)
		**out = **in
	}
